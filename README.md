...
- The Fuse Network and the networks' smart contracts, via the [web3dart](https://github.com/simolus3/web3dart) package thegraph
- The [graphql API](https://api.thegraph.com/subgraphs/name/fuseio)|[graphql API (Inactive)](https://graph.fuse.io/subgraphs/name/fuseio/fuse/graphql) (provided by [thegraph's node](https://thegraph.com/)) with [docs](https://developers.fuse.io/fuse-dev-docs/fuse-studio/subgraphs) provides a convenient API for reading from the network. More info about the API can be found [here](https://github.com/fuseio/fuse-graph) with [landing page](https://thegraph.com/hosted-service/subgraph/fuseio/fuse-entities)
...
## As an entrepreneur or a community manager
